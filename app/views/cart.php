               ...
               <table class="table table-hover table-condensed">
                  ...
                  <tbody>
                     ...
                     <form action='<?php echo BASE_URL ?>/giohang/xoagiohang' method="post">
                        ...
                        <tr class="tr">
                           <td data-th="Hình ảnh">
                              <div class="col_table_image col_table_hidden-xs"><img src="<?php echo BASE_URL ?>/public/uploads/product/<?php
                                 echo $value['product_image']?>" alt="Máy in laser Canon LBP251DW" class="img-responsive"/></div>
                           </td>
                           <td data-th="Sản phẩm">
                           ...
                           <td data-th="Số lượng">
                              <div class="clear margintop5">
                                 <div class="floatleft">
                                    <input type="number" class="inputsoluong" name="qty[<?php echo $value['product_id'] ?>]" min="1"  value="<?php echo $value['product_quantity'] ?>">
                                 </div>
                           ...
                           <td class="actions aligncenter" data-th="">
                              <input type="hidden" value="<?php echo $value['product_id'] ?>" name="cart_id">
                           ...
                           <td>
                              <button type="submit" style="box-shadow: none;" value="<?php echo $value['product_id'] ?>" name="update_cart" class="btn btn-sm btn-success">Cập nhật</button>  
                           </td>
                        </tr>
                        <?php
                             }
                     ...
                     <tr>
                        <td colspan="7" class="textright_text">
                           <div class="sum_price_all">
                              <span class="text_price"><?php echo number_format($total,0,',','.').'đ' ?></span>: 
                           </div>
                        </td>
                     </tr>
                     <?php
                           ...
                           <div class="content-box_contact">
                              ...
                              <div class="row">
                                 <div class="input">
                                    ...
                                    <input type="text" name="sodt" required onkeydown="return checkIt(event)" class="clsip">
                                 </div>
                                 <div class="clear"></div>
                              </div>
                              <!---row---->
