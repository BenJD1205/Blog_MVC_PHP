                           ...
                           <div class="grids_in">
                              <div class="content">
                                 ...
                                 <div class="img-right-pro">
                                    ...
                                    <img class="lazy img-pro content-image pic" src="<?php echo BASE_URL ?>/public/uploads/product/<?php echo $pro['image_product'] ?>" data-original="image/iphone.png" alt="<?php echo $pro['title_product'] ?>" />
                                    </a>
                                 ...
                                 <div class="price_old_new">
                                    <div class="price">
                                       <span class="news_price"><?php echo number_format($pro['price_product'],0,',','.').'đ' ?></span>
                                    </div>
                                 </div>
                              </div>
                           </div>
