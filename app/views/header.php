...
<html lang="en-CA">
   <head>
      ...
      <link rel="icon" type="image/png" href="<?php echo BASE_URL ?>/public/template/Default/img/favicon.png">
      <!--tkw-->
                     ...
                     <div id='cssmenu'>
                        <ul>
                           ...
                           <li class=''>
                              ...
                              <ul>
                                 <?php
                                    foreach ($cate_post as $key => $ca_post) {
                                 ?>
                                 <li>
                                    <a href='<?php echo BASE_URL ?>/tintuc/danhmuc/<?php echo $ca_post['id_category_post'] ?>'><span><?php echo $ca_post['title_category_post'] ?></span></a>
                                 </li>
                                 <?php
                                    }
                                 ?>
                           ...
                           <li class=''><a href='<?php echo BASE_URL ?>/giohang'>giohang</a></li>
